...
namespace Schedule.Core
{
    ...
    public static class Excel
    {
        ...
        public static DocumentFormat.OpenXml.Packaging.SpreadsheetDocument CreateWorkbook(string fileName)
        {
            ...
            {
                MessageBox.Show(exception.Message, "Excel OpenXML basics", MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
        ...
        public static bool AddBasicStyles(DocumentFormat.OpenXml.Packaging.SpreadsheetDocument spreadsheet)
        {
            ...
            // My Time
            NumberingFormat nf2decimal2 = new NumberingFormat();
            nf2decimal2.NumberFormatId = UInt32Value.FromUInt32(5);
            nf2decimal2.FormatCode = StringValue.FromString("H:mm");
            stylesheet.NumberingFormats.Append(nf2decimal2);
            ...
            stylesheet.GetFirstChild<DocumentFormat.OpenXml.Spreadsheet.CellFormats>().InsertAt<DocumentFormat.OpenXml.Spreadsheet.CellFormat>(
               new DocumentFormat.OpenXml.Spreadsheet.CellFormat()
               {
                   ApplyNumberFormat = true,
                   FormatId = 0,
                   NumberFormatId = nf2decimal2.NumberFormatId,
                   FontId = 0,
                   FillId = 0,
                   BorderId = 0
               },
