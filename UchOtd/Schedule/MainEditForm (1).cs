...
namespace UchOtd.Schedule
{
    public partial class MainEditForm : Form
    {
        ...
        private void ExportInWord_Click(object sender, EventArgs e)
        {
            ...
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 90, (int)WordFacultyFilter.SelectedValue, 6);
            }
            else
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 90, -1, 6);
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (WordOneFaculty.Checked)
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 80, (int)WordFacultyFilter.SelectedValue, 6);
            }
            else
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 80, -1, 6);
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (WordOneFaculty.Checked)
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 90, (int)WordFacultyFilter.SelectedValue, 7);
            }
            else
            {
                WordExport.ExportWholeSchedule(Repo, "Расписание.docx", false, false, 90, -1, 7);
            }
        }
